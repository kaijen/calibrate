...
Ein Tipp auf ein Diagramm öffnet es als Vollbild-Ansicht im Querformat. In der Vollbild-Ansicht lässt sich das Diagramm per Pinch-to-Zoom vergrößern und verschieben; ein Doppeltipp setzt den Zoom zurück. Beim Winkler-Score-Verlauf öffnet ein Tipp auf einen Datenpunkt die zugehörige Schätzung; zurück führt zur Statistik.
